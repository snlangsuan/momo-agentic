...
แนวทางสำหรับ AI agents (เช่น Claude Code) ที่ทำงานกับ repo นี้
...
โปรเจคนี้สร้าง LLM application — โมเดลที่แนะนำ default คือตระกูล Claude รุ่นล่าสุด
(เช่น `claude-opus-4-8`) เมื่อเขียน adapter ตัวอย่างหรือ docs ที่อ้างถึงโมเดล
